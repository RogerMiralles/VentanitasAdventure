...
namespace TextAdventureXam.Maldiciones
{
    class Maldicion
    {
        ...
        public Maldicion(int id)
        {
            ...
            switch (this.id) {
                ...
                case 4:
                    ...
                    for (int i = 0; i < Program.ObteJuego().lvlLayout.Count; i++)
                        Program.ObteJuego().lvlLayout[i].SetVisible(0);
                    Program.ObteJuego().pl.currentRoom.SetVisible(2);
                    break;
            }
        }
